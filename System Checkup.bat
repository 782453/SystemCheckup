...
echo [08/25] Clearing error reports...
...
echo [09/25] Clearing Delivery Optimization cache...
...
echo [10/25] Clearing Windows Update download cache...
net stop wuauserv >nul 2>&1
...
net start wuauserv >nul 2>&1
echo [11/25] Clearing font cache...
...
echo [15/25] Clearing Windows Defender scan history...
...
echo [18/25] Clearing Chrome cache...
if exist "%LOCALAPPDATA%\Google\Chrome\User Data\Default\Cache" (del /f /s /q "%LOCALAPPDATA%\Google\Chrome\User Data\Default\Cache\*.*" >nul 2>&1)
echo [19/25] Clearing Edge cache...
if exist "%LOCALAPPDATA%\Microsoft\Edge\User Data\Default\Cache" (del /f /s /q "%LOCALAPPDATA%\Microsoft\Edge\User Data\Default\Cache\*.*" >nul 2>&1)
echo [20/25] Clearing Discord cache...
if exist "%APPDATA%\discord\Cache" (del /f /s /q "%APPDATA%\discord\Cache\*.*" >nul 2>&1)
if exist "%APPDATA%\discord\Code Cache" (del /f /s /q "%APPDATA%\discord\Code Cache\*.*" >nul 2>&1)
if exist "%APPDATA%\discord\GPUCache" (del /f /s /q "%APPDATA%\discord\GPUCache\*.*" >nul 2>&1)
echo [21/25] Clearing Steam cache...
if exist "%ProgramFiles(x86)%\Steam\steamapps\downloading" (del /f /s /q "%ProgramFiles(x86)%\Steam\steamapps\downloading\*.*" >nul 2>&1)
if exist "%LOCALAPPDATA%\Steam\htmlcache" (del /f /s /q "%LOCALAPPDATA%\Steam\htmlcache\*.*" >nul 2>&1)
echo [22/25] Clearing Windows icon cache...
if exist "%LOCALAPPDATA%\IconCache.db" (del /f /q "%LOCALAPPDATA%\IconCache.db" >nul 2>&1)
if exist "%LOCALAPPDATA%\Microsoft\Windows\Explorer\iconcache_*.db" (del /f /s /q "%LOCALAPPDATA%\Microsoft\Windows\Explorer\iconcache_*.db" >nul 2>&1)
echo [23/25] Clearing VS Code cache...
if exist "%APPDATA%\Code\Cache" (del /f /s /q "%APPDATA%\Code\Cache\*.*" >nul 2>&1)
if exist "%APPDATA%\Code\CachedData" (del /f /s /q "%APPDATA%\Code\CachedData\*.*" >nul 2>&1)
echo [24/25] Clearing Spotify cache...
if exist "%LOCALAPPDATA%\Spotify\Storage" (del /f /s /q "%LOCALAPPDATA%\Spotify\Storage\*.*" >nul 2>&1)
if exist "%LOCALAPPDATA%\Spotify\Data" (del /f /s /q "%LOCALAPPDATA%\Spotify\Data\*.*" >nul 2>&1)
echo [25/25] Clearing Zoom cache...
if exist "%APPDATA%\Zoom\data" (del /f /s /q "%APPDATA%\Zoom\data\*.*" >nul 2>&1)
if exist "%APPDATA%\Zoom\logs" (del /f /s /q "%APPDATA%\Zoom\logs\*.*" >nul 2>&1)
echo.
cleanmgr /sagerun:99
goto :eof
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
